...
<main>
    ...
    <section class="roomSection">
        ...
        <h1 class="roomSection__title">Luxury Double Bed</h1>
        <p class="roomSection__price">$345<span class="roomSection__price--perNight">/Night</span></p>
        <img class="roomSlider__slides--roomImg" src="src/assets/imgs/room-details.jpg" alt="Hotel room" />
    </section>
    <section class="roomSectionDesktop">
        <div class="roomSectionDesktop__container">
          <div class="roomSectionDesktop__container__subcontainer">
            ...
            <h1 class="roomSectionDesktop__container__subcontainer__title">Luxury Double Bed</h1>
          </div>
          <p class="roomSectionDesktop__container__price">$345<span class="roomSectionDesktop__container__price--perNight">/Night</span>
          </p>
        </div>

        <img class="roomSectionDesktop__roomImg" src="src/assets/imgs/room-details.jpg" alt="Hotel room" />
    ...
    <section class="employeeSection">
        <div class="employeeSection__container">
            <div class="employeeSection__container__imgContainer">
                <img class="employeeSection__container__imgContainer__portrait" src="src/assets/imgs/DPFounder.png"
                    alt="Employee image" />
        ...
        <div class="relatedRoomsSection__desktopContainer">
            <div class="relatedRoomsSection__swiper__slide">
                <div style="position: relative">
                    <img
                        ...
                        src="src/assets/imgs/room-info.svg"
                        alt="Room extras"
                    />
                    <img
                        class="relatedRoomsSection__swiper__slide__roomImg"
                        src="src/assets/imgs/room-img1.jpg"
                        alt="Hotel room"
                    />
                    <h1 class="relatedRoomsSection__swiper__slide__title">Minimal Duplex Room</h1>
                    <p class="relatedRoomsSection__swiper__slide__description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore.
                    </p>
                    <div class="relatedRoomsSection__swiper__slide__container">
                        <p class="relatedRoomsSection__swiper__slide__container__price">$345
                            <span class="relatedRoomsSection__swiper__slide__container__price--perNight">/Night</span>
                        </p>
            ...
            <div class="relatedRoomsSection__swiper__slide">
                <div style="position: relative">
                    ...
                    <img
                        class="relatedRoomsSection__swiper__slide__roomImg"
                        src="src/assets/imgs/room-img2.jpg"
                        alt="Hotel room"
                    />
                    <h1 class="relatedRoomsSection__swiper__slide__title">Single Room</h1>
                    <p class="relatedRoomsSection__swiper__slide__description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore.
                    </p>
            ...
            <div class="relatedRoomsSection__swiper__slide">
                <div style="position: relative">
                    ...
                    <img
                        class="relatedRoomsSection__swiper__slide__roomImg"
                        src="src/assets/imgs/room-img3.jpg"
                        alt="Hotel room"
                    />
                    <h1 class="relatedRoomsSection__swiper__slide__title">Double Room</h1>
                    <p class="relatedRoomsSection__swiper__slide__description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore.
                    </p>
